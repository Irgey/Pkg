			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "e8250ca1-0d89-9645-f303-d800ba0434d5",
							"code": "PDS_UsrPrice",
							"caption": "#ResourceString(PDS_UsrPrice)#",
							"dataValueType": 32
						},
						{
							"id": "4dd5efe1-39a4-2175-5739-e693170968a9",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "deb0d2d6-b05b-cbed-f683-c6f067713b7a",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "263bf41d-15b2-932b-2f72-190e303d47f0",
							"code": "PDS_CreatedOn",
							"caption": "#ResourceString(PDS_CreatedOn)#",
							"dataValueType": 7
						},
						{
							"id": "563a00ae-1e0a-104e-abe1-48b09f62fb43",
							"code": "PDS_UsrNumber",

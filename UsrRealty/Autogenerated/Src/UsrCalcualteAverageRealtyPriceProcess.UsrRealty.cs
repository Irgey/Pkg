namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcualteAverageRealtyPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcualteAverageRealtyPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcualteAverageRealtyPriceProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			esq.Filters.Add(offerTypeFilter); // ...WHERE UsrTyperId = :typeId AND UsrOfferTypeId = :offertypeId
